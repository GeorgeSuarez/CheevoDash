...
export function ComparisonsView({ initialData }: { initialData: DashboardData }) {
  ...
  return (
    <div className="flex min-h-screen w-full">
      <Sidebar user={data.user} activeHref="/comparisons" />
      <main
      ...
      >
        <div className="mx-auto max-w-7xl">
          ...
          <div className="-mx-4 mb-4 flex items-center gap-3 lg:hidden">
            <MobileSidebar user={data.user} activeHref="/comparisons" />
            <h2 className="text-xl font-bold text-foreground">Comparisons</h2>
          </div>
          ...
          <div className="flex flex-col justify-between gap-4 pb-6 sm:flex-row sm:items-start">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                See how your achievement progress stacks up.
              </p>
            </div>
